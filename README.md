...
**every-claude-code-learning** is organized to **teach you how to use [Everything Claude Code (ECC)](https://github.com/affaan-m/everything-claude-code)**—the production agent harness stack (agents, skills, slash commands, hooks, rules, MCP configs) for **Claude Code**, **Codex**, **Cowork**, and similar tools. This repo bundles ECC’s real configuration and scripts so you can follow tutorials, run the test suite, and practice workflows end to end.

| If you want to… | Start here |
|-----------------|------------|
| Follow a structured path (labs + links) | [**Simplified Chinese tutorial (8 parts)**](docs/zh-CN/tutorial/README.md) |
